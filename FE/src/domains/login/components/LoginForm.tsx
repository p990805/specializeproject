  ...
  return (
    <div className="flex flex-col h-[75vh] w-[45vw] bg-white rounded-2xl shadow-2xl p-9">
      ...
      <div className="px-7">
        ...
        <div className=" flex flex-col gap-6 space-y-6 flex-grow p-7">
          <div className="border-b border-gray-300 pb-2">
            <input type="text" className="w-full focus:outline-none" placeholder='아이디를 입력하세요' />
          </div>
          ...
          <div className="border-b border-gray-300 pb-2 relative">
            <div className="flex items-center">
              <input 
                ...
                className="w-full focus:outline-none shadow-2xl" 
          ...
          <div className="">
            ...
            <div className="text-center mt-4 text-sm text-gray-500">
              Don't have an account? <button onClick={onClickGoToSignup} className="text-indigo-800 cursor-pointer hover:text-indigo-500">Signup Here</button>
            </div>
          </div>
          {/*버튼 영역 종료 */}
        </div>
